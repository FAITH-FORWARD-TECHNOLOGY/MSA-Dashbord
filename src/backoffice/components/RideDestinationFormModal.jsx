...
// Modal sobre pour créer/éditer une destination de covoiturage.
// Calquée sur CelluleFormModal : fond sombre, carte blanche centrée,
...
function RideDestinationFormModal({ destination, onClose, onSubmit }) {
    ...
    const [formData, setFormData] = useState({
        ...
        locationLink: (() => {
            // Si on a des coords, on reconstruit un lien Google Maps pour l'affichage
